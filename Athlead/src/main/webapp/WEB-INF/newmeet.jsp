...
<body>
   ...
   <h1>Plan your next Meet!</h1>
<form:form action="/meets" method="post" modelAttribute="newMeet">
	<form:errors path="*"/>
	<form:hidden path="creator" value="${logged_id }"/>
    <p>
        <form:label path="title">Briefly, what is your meet:</form:label>
